...
import com.lxb.dao.*;
import com.lxb.dto.SearchLogDto;
import com.lxb.exception.ParamException;
import com.lxb.model.*;
import com.lxb.param.SearchLogParam;
...
public class SysLogService {
    ...
    public void recover(int id) {
        ...
        switch (sysLog.getType()) {
            ...
            case  LogType.TYPE_USER:
                ...
                Preconditions.checkNotNull(beforeUser, "待还原的部门已经不存在了");
                if (StringUtils.isBlank(sysLog.getNewValue()) || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new ParamException("新增和删除操作不做还原");
                }
            ...
            case  LogType.TYPE_ACL_MODULE:
                ...
                Preconditions.checkNotNull(beforeAclModule, "待还原的部门已经不存在了");
                if (StringUtils.isBlank(sysLog.getNewValue()) || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new ParamException("新增和删除操作不做还原");
                }
            ...
            case  LogType.TYPE_ACL:
                ...
                Preconditions.checkNotNull(beforeAcl, "待还原的部门已经不存在了");
                if (StringUtils.isBlank(sysLog.getNewValue()) || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new ParamException("新增和删除操作不做还原");
                }
            ...
            case  LogType.TYPE_ROLE:
                ...
                Preconditions.checkNotNull(beforeRole, "待还原的部门已经不存在了");
                if (StringUtils.isBlank(sysLog.getNewValue()) || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new ParamException("新增和删除操作不做还原");
                }
    ...
    /**
     * return the page after searching
     * @param param
     * @param page
     * @return the page after searching
     */
    ...
    /**
     * To save dept log, including adding, editing and deleting.
