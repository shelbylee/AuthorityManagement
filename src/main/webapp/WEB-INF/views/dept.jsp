    ...
    <form id="deptForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            ...
            <tr>
                ...
                <td><input name="name" id="deptName" value="" class="text ui-widget-content ui-corner-all"></td>
            </tr>
            <tr>
                <td><label for="deptSeq">顺序</label></td>
                <td><input name="seq" id="deptSeq" value="1" class="text ui-widget-content ui-corner-all"></td>
            </tr>
            <tr>
...
<script type="text/javascript">
    $(function() {
        ...
        var deptList; // store tree dept list
        var deptMap = {}; // store dept map
        var optionStr = "";
        ...
        function loadUserList(deptId) {
            // TODO:
            console.log("load userList, dept:" + deptId);
        }
